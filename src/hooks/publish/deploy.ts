import { VercelClientOptions, DeploymentOptions, createDeployment } from "@vercel/client";
import bytes from "bytes";
import { Signale } from "signale";

export const deploy = async (clientOptions: VercelClientOptions, deploymentOptions: DeploymentOptions, logger: Signale<"error" | "success" | "warn" | "log">): Promise<void> => {
